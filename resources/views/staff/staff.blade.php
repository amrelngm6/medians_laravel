                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center  gap-2 gap-md-5 w-full flex">
                            ...
                            <a class="btn btn-md btn-primary me-2 open-modal " href="{{route('Staff.create_modal')}}">
                                New Staff </a>
                        </div>
                                ...
                                <table
                                    ...
                                    <thead class="text-start bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            ...
                                            <th class="text-start role" data-sort="role">Role</th>
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" ">
                                                <a href="{{route('Staff.tabs.overview', $staff->staff_id)}}" class="pt-4">{{$staff->name}} </a>
                                            </td>
                                            <td class=" ">
                                                <h6 class="pt-4">{{$staff->role->name}} </h6>
                                            </td>
                                            <td class=" status">
                                                <span
                                                    class="badge round-danger px-2.5 py-0.5 inline-block text-xs font-medium rounded border {{$staff->status ? 'bg-success' : 'bg-orange-100'}} border-transparent text-orange-500">{{$staff->status ? 'Active' : 'Disabled'}}</span>
                                            </td>
                                            <td class=" action">
                                                    ...
                                                    <ul class="show-on-hover absolute   z-50  py-2 mt-0 text-start list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                        ...
                                                        <li>
                                                            <a class="open-modal block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="{{route('Staff.edit_modal', $staff->staff_id)}}">
