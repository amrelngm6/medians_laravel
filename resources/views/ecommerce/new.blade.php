                        ...
                        <div>
                            <div class="card">
                                <div class="card-body pb-0">
                                    <div class="lg:flex gap-10  relative" id="upload-media-form">
                                        <label class="flex cursor-pointer py-4 px-2   bg-gray-200  w-full border-danger">
                                            <img id="imagePreview" src="/data/icons/picture.svg" class="dark:opacity-30">
                            ...
                            <div class="card">
                                <div class="card-title py-4 flex">
                                    ...
                                    <div class="rounded-circle bg-danger mt-2 p-0 w-10px h-10px"></div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body px-0 pt-0">
                                    <div class="w-full"><select required="" name="category" multiple
                                            class="select2 form-control py-2 form-control-solid" placeholder="Category">
                                            <!---->
                        ...
                        <div class="tab-content px-0" id="tab-container">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-10 fv-row">
                                                        ...
                                                        <div class="position-relative flex">
                                                            <i class="fs-3 position-absolute top-0 m-4  bx bx-link-alt"></i>
                                                            <input disabled="" value="https://example.com/"
                                                                class="bg-gray-200 form-control form-control-solid w-auto ps-12  px-4" />
                                                            <input type="text" class="w-full form-control form-control-solid" />
                                                        </div>
                                                    ...
                                                    <div class="mb-10 fv-row">
                                                        <label class="form-label fw-bold gap-6 flex"><span class="fw-bold">Short
                                                                Description</span><span class="px-4 text-muted"
                                                                v-text="">English</span> </label>
                                                        <textarea class="form-control-solid form-control"></textarea>
                                                        <div class="text-muted fs-7"> Set a description to the item for
                                                            better visibility
                                                        </div>
                                                    </div>
                                                    <div class="mb-10 fv-row">
                                                        <label class="form-label fw-bold gap-6 flex"><span class="fw-bold">Page
                                                                Content</span><span class="px-4 text-muted" v-text="">English</span>
                                                        </label>
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="w-full" callback="o=>{t.activeItem.value.price=o}">
                                            <!---->
                                            <div class="mb-10 fv-row"><label class="required form-label fw-bold">Price</label><input
                                                    type="number" name="price" class="form-control form-control-solid mb-2">
                                        ...
                                        <div class="w-full" callback="o=>{t.activeItem.value.old_price=o}">
                                            ...
                                            <div class="mb-10 fv-row"><label class="required form-label fw-bold">Old
                                                    price</label><input type="number" name="old_price"
                                            ...
                                            <div class="col-md-8 fv-row"><label
                                                ...
                                                <div class="w-full">
                                                    <div class="w-full">
                                                        ...
                                                        <!---->
                                                        <!---->
                                                        <!----><select required="" name="tax_type"
                                                            class="form-control form-control-solid" placeholder="Tax">
                                                            <!---->
                                                            <option value="">Free tax</option>
                                            ...
                                            <div class="col-md-8 fv-row"><label
                                                ...
                                                <div class="w-full">
                                                    <div class="w-full">
                                                        ...
                                                        <!---->
                                                        <!---->
                                                        <!----><select required="" name="vat_type"
                                                            class="form-control form-control-solid" placeholder="Vat">
                                                            <!---->
                                                            <option value="">Free Vat</option>
                                                            <option value="percent">Vat percentage</option>
                                            ...
                                            <div class="w-full">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-group mt-5">
                                                        <button data-element="#variants" data-container="#variants-container"
                                                            type="button" class="btn btn-sm btn-light-primary append-html"
                            ...
                            <div id="images-tab" class="tab-element fade show active hidden">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body " id="images">
                                        ...
                                        <div class="image-input image-input-outline col-md-3"
                                            ...
                                            <label
                                                ...
                                                <input type="file" class="hidden" name="avatar" accept=".png, .jpg, .jpeg">
                                    ...
                                    <button data-container="#images" type="button" class="btn btn-primary append-html"
                                ...
                                <div class="d-flex flex-column gap-7 gap-lg-10">
                                    <div class="card card-flush py-4">
                                        <div class="card-header flex flex-nowrap">
                                            ...
                                            <ul class="flex gap-10 flex-none">
                                                <li class="text-lg flex py-5 gap-2 cursor-pointer"><img src="/data/flags/en.svg"
                                                        class="rounded-circle w-30px h-30px border-1 border border-gray-600 p-1"><a
                                                        href="javascript:;" class="pt-1 text-danger font-bold">English</a>
                                                </li>
                                                <li class="text-lg flex py-5 gap-2 cursor-pointer"><img src="/data/flags/ar.svg"
                                                        class="rounded-circle w-30px h-30px border-1 border border-gray-600 p-1"><a
                                                        href="javascript:;" class="pt-1 opacity-75 text-gray-400">Arabic</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="mb-10"><label class="form-label">Meta Tag Title
                                                    (english)</label><input type="text" class="form-control form-control-solid mb-2"
                                            ...
                                            <div class="mb-10"><label class="form-label">Meta Tag
                                                    Description</label><textarea class="form-control form-control-solid"></textarea>
                                            ...
                                            <div><label class="form-label">Meta Tag Keywords</label><input
                                                    id="ecommerce_add_item_meta_keywords" class="form-control form-control-solid">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="w-full" callback="o=>{t.activeItem.value.product_fields.sku=o}">
                                                ...
                                                <div class="mb-10 fv-row"><label
                                                        class="required form-label fw-bold">SKU</label><input type="text"
                                                        name="params[sku]" class="form-control mb-2 form-control-solid">
                                                    <div class="text-muted fs-7"></div>
                                                </div>
                                                <!---->
                                                <!---->
                                            </div>
                                            <div class="w-full" callback="o=>{t.activeItem.value.product_fields.barcode=o}">
                                                <!---->
                                                <div class="mb-10 fv-row"><label
                                                        class="required form-label fw-bold">Barcode</label><input type="text"
                                                        name="params[barcode]" class="form-control mb-2 form-control-solid">
                                                    <div class="text-muted fs-7">Enter the product barcode number</div>
                                                </div>
                                                <!---->
                                                <!---->
                                            </div>
                                            <div class="w-full" callback="o=>{t.activeItem.value.product_fields.unit=o}">
                                                <!---->
                                                <div class="mb-10 fv-row"><label
                                                        class="required form-label fw-bold">Unit</label><input type="text"
                                                        name="params[unit]" class="form-control mb-2 form-control-solid">
                                                    <div class="text-muted fs-7">Unit of the product to sale</div>
                                                </div>
                                                <!---->
                                                <!---->
                                            </div>
                                            <div class="w-full" callback="o=>{t.activeItem.value.product_fields.weight=o}">
                                                <!---->
                                                <div class="mb-10 fv-row"><label
                                                        class="required form-label fw-bold">Weight</label><input type="text"
                                                        name="params[weight]"
                                            ...
                                            <div class="w-full"
                                                ...
                                                <!---->
                                                <div class="mb-10 fv-row"><label class="required form-label fw-bold">Minimum
                                                        purchase qty</label><input type="number" name="params[min_purchase_qty]"
