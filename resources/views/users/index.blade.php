                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center  gap-2 gap-md-5 w-full flex">
                            ...
                            <a class="btn btn-md btn-primary me-2 open-modal" href="{{route('User.create')}}">
                                New Users </a>
                        </div>
                            ...
                            <div class="table" data-pattern="priority-columns">
                                <table
                                    ...
                                    <thead class="text-start bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            <th class="text-start w-20" data-sort="Users_id">ID</th>
                                            <th class="text-start Users_name" data-sort="Users_name">Name</th>
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td class=""> <a href="{{route('User.tabs.overview', $user->id)}}">{{$user->name ?? ''}}</a> </td>
                                            <td class=" ">
                                            </td>
                                            <td class=""> {{$user->role->name ?? ''}} </td>
                                            <td class=" status">
                                                <span
                                                    class="badge round-danger px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-{{$user->status_model->color ?? 'danger' }} border-transparent text-orange-500">{{$user->status_model->name ?? ''}}</span>
                                            </td>
                                            <td class=" action">
                                                <div class="relative show-child">
                                                    ...
                                                    <ul class="show-on-hover absolute   z-50  py-2 mt-0 text-start list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                        ...
                                                        <li>
                                                            <a data-path="{{route('User.delete', $user->id)}}" class="delete-item block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="#!">
