    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="modal_edit_target_form" method="POST" class="ajax-form form" action="{{route('StatusList.update', $status->status_id)}}">
                    @csrf
                    <input name="status_id" type="hidden" value="{{$status->status_id}}" />
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">
                            Update <span class="text-danger">{{$status->name}}</span> Models Status list.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input class="form-control form-control-solid" placeholder="Status name " value="{{$status->name}}"
                                name="name" />
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input class="form-control form-control-solid" type="number" placeholder="Sort" value="{{$status->sort}}" name="sort" />
                    </div>
                    <!--end::Input group-->
                            ...
                            <div class="d-flex align-items-center pt-6">
                                ...
                                <label class="form-check form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-20px" type="radio"
                                        name="color" value="{{$color}}" @if ($color == $status->color ) checked @endif />
