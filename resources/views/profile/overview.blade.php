...
@section('title', 'User Profile - Overview')
@section('css')
            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-right hidden-xs">
                        <ol class="breadcrumb">
                            <li>
                                <a href="{{route(App::getLocale() . '.index')}}"><i class="fa fa-home"></i>Home</a>
                            </li>
                            <li>
                                <a href="#">Profile</a>
                            </li>
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 active"
                                    href="{{route(App::getLocale() . '.profile_overview')}}">
                                    Overview </a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
            ...
            <div class="card mb-5 mb-xl-10" id="profile_details_view">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <span class="fw-bold fs-6 text-gray-800">Anthony Smith</span>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            <span class="fw-semibold text-gray-800 fs-6">Medians</span>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <span class="fw-bold fs-6 text-gray-800 me-2">+20 1087 654 123</span>
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <a href="#" class="fw-semibold fs-6 text-gray-800 text-hover-primary">info@example.com</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
