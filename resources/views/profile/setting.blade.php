            ...
            <div class="wrapper main-wrapper row" style=''>
                    ...
                    <div class="card mb-5 mb-xl-10 py-0">
                        <div class="card-body pt-9 pb-0">
                            ...
                            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                                ...
                                <!--begin::Nav item-->
                                <li class="nav-item mt-2">
                                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="{{route(App::getLocale() . '.profile_setting')}}">
                                        Settings </a>
                                </li>
                                <!--end::Nav item-->
                                <!--begin::Nav item-->
                ...
                <div class="card mb-5 mb-xl-10" id="profile_details_view">
                    ...
                    <div class="card-body p-9">
                        <form id="account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url(/data/profile/avatar-1.png)">
                                            </div>
                                            <label
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="flex gap-10">
                                            <!--begin::Col-->
                                            <div class="w-full fv-row fv-plugins-icon-container">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="Email" name="Email" class="form-control form-control-lg form-control-solid"
                                            placeholder="Email" value="mail@example.com">
                                        <div
                                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="company" class="form-control form-control-lg form-control-solid"
                                            placeholder="Company name" value="example">
                                        <div
                                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="tel" name="phone" class="form-control form-control-lg form-control-solid"
                                            placeholder="Phone number" value="+20 1087 654 123">
                                        <div
                                            class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="website" class="form-control form-control-lg form-control-solid"
                                            placeholder="Company website" value="example.com">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select name="country" aria-label="Select a Country" data-control="select2"
                                            ...
                                            data-select2-id="select2-data-9-rw4w" tabindex="-1" aria-hidden="true"
                                            data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-11-zmnn">Select a Country...
                                            </option>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        <select name="language" aria-label="Select a Language" data-control="select2"
                                            ...
                                            data-select2-id="select2-data-12-hoxl" tabindex="-1" aria-hidden="true"
                                            data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-14-yqxj">Select a Language...
                                            </option>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                                            ...
                                            class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                            data-select2-id="select2-data-15-urbc" tabindex="-1" aria-hidden="true"
                                            data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-17-rmr1">Select a Timezone..
                                            </option>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select name="currnecy" aria-label="Select a Currency" data-control="select2"
                                            ...
                                            class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                            data-select2-id="select2-data-18-jpn3" tabindex="-1" aria-hidden="true"
                                            data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-20-og0u">Select a currency..
                                            </option>
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                ...
                                <button type="submit" class="btn btn-primary" id="account_profile_details_submit">Save
                                    Changes</button>
                            </div>
                            <!--end::Actions-->
                            <input type="hidden">
