                    ...
                    <div class="w-full">
                        <div class="col-xs-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="div">
                                        <canvas class="bar-chartjs" width="600"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="card ">
                                ...
                                <div class="card-body ">
                                    <canvas class="clean-bar-chartjs" data-color="black" width="600"></canvas>
                                </div>
                                <div class="card-body ">
                                    <canvas class="clean-bar-chartjs" data-color="#F8285A" width="600"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
