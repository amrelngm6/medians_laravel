                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Chart JS - Line & Area</h1>
                    ...
                    <div class="w-full">
                        <div class="col-xs-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="div">
                                        <canvas class="line-chartjs" width="600"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-4">
                            <div class="card ">
                                ...
                                <div class="card-body ">
                                    <canvas class="clean-line-chartjs" data-color="black" width="600"></canvas>
                                </div>
                                <div class="card-body ">
                                    <canvas class="clean-line-chartjs" data-color="#F8285A" width="600"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
