                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center  gap-2 gap-md-5 w-full flex">
                            ...
                            <a class="btn btn-md btn-primary me-2 open-modal " href="{{route('Business.create')}}">
                                New Business </a>
                        </div>
                                ...
                                <table
                                    ...
                                    <thead class="text-start bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            ...
                                            <th class="text-start Lead_name" data-sort="owner">Category</th>
                                            <th class="text-start Lead_name" data-sort="owner">Owner</th>
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" ">
                                                <h6 class="">{{$Business->category->name ?? ''}} </h6>
                                            </td>
                                            <td class=" ">
                                                <a class="text-danger fw-bold" href="{{route('Staff.tabs.overview', $Business->owner_id ?? 0)}}"> {{$Business->owner->name ?? ''}} </a>
                                            </td>
                                            <td class=" action">
                                                    ...
                                                    <ul class="show-on-hover absolute   z-50  py-2 mt-0 text-start list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                        ...
                                                        <li>
                                                            <a class="open-modal block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="{{route('Business.edit_modal', $Business->business_id)}}">
                                                                <span class="align-middle">Edit</span></a>
                                                        </li>
                                                        <li>
                                                            <a data-path="{{route('Business.delete', $Business->business_id)}}" class="delete-item block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="#!">
