...
<body class="loginpage @if(app()->getLocale() === 'ar') rtl @endif">
        <div class="login-bg w-full" style="background-image: url(/data/dashboard/login-bg.jpg);">
            ...
            <form action="{{route('Staff.signin')}}" id="signup-form" class="form ajax-form mx-auto my-20">
                @csrf
                ...
                <p class="text-center fs-5">Don't have an account ? <a href="{{route('signup_page')}}" class="fs-5 text-danger">Sign up</a>
