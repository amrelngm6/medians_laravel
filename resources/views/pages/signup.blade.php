...
<body class="loginpage @if(app()->getLocale() === 'ar') rtl @endif">
    ...
    <div class="login-bg w-full" style="background-image: url(/data/dashboard/login-bg.jpg);">
        ...
        <form action="{{route('Staff.register')}}" id="signup-form" class="w-500px form ajax-form mx-auto my-20">
            @csrf <!-- {{ csrf_field() }} -->
            ...
            <div class="flex w-full gap-10">
                <div class=" w-full">
                    ...
                    <div class="inputForm">
                        ...
                        <input type="text" name="first_name" class="input px-12" placeholder="Enter your Name">
                    </div>
                </div>
                <div class=" w-full">
                    <div class="flex-column py-4">
                    ...
                    <div class="inputForm">
                        ...
                        <input type="text" name="last_name" class="input px-12" placeholder="Enter your Name">
                    </div>
                </div>
            ...
            <p class="text-center fs-5">Already have an account ? <a href="{{route('Staff.login')}}"
