    ...
    <div class="w-full" >
        ...
        <form class="form mx-auto mt-0 transparent bg-transparent text-white">
            ...
            <div class="inputForm">
                ...
                <input type="text" class="input px-12" placeholder="Enter your Email">
            </div>
            ...
            <div class="inputForm relative">
                ...
                <input type="password" class="input px-12" placeholder="Enter your Password">
            ...
            <div class="flex-row fs-5">
                <div class="flex gap-2">
                    <input type="checkbox" />
                    <label class="text-white pt-2">Remember me </label>
                </div>
                <span class="fs-5 pt-2">Forgot password ?</span>
            </div>
            <a href="/" class="button-submit bg-danger">Sign Up</a>
            <p class="text-center  fs-5">Already have an account ? <a href="{{route(App::getLocale() . '.pages_login2')}}" class="fs-5 text-danger">Sign in</a>
