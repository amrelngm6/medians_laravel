...
<body class="loginpage @if(app()->getLocale() === 'ar') rtl @endif">
    ...
    <div class="login-bg w-full" style="background-image: url(/data/dashboard/login-bg.jpg);">
        ...
        <form class="form mx-auto my-20 bg-transparent transparent text-white">
            ...
            <a href="/" class="button-submit bg-danger">Sign In</a>
            <p class="text-center fs-5">Don't have an account ? <a href="{{route(App::getLocale() . '.pages_signup2')}}"
                    class="fs-5 text-danger">Sign up</a>
