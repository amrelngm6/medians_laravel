                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Leads Sources list </h1>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center  gap-2 gap-md-5 w-full flex">
                            ...
                            <a class="btn btn-md btn-primary me-2 open-modal " data-modal="#new-source-modal" href="{{route('LeadSource.create_modal')}}">
                                New Source </a>
                        </div>
                            ...
                            <div class="table" data-pattern="priority-columns">
                                <table
                                    ...
                                    <thead class="text-start bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            <th class="text-start w-4" data-sort="source_id">ID</th>
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" status">
                                                <span
                                                    class="badge round-danger px-2.5 py-0.5 inline-block text-xs font-medium rounded border {{$source->status ? 'bg-success' : 'bg-orange-100'}} border-transparent text-orange-500">{{$source->status ? 'Active' : 'Disabled'}}</span>
                                            </td>
                                            <td class=" action">
                                                    ...
                                                    <ul class="show-on-hover absolute   z-50  py-2 mt-0 text-start list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                        ...
                                                        <li>
                                                            <a class="open-modal block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="{{route('LeadSource.edit_modal', $source->source_id)}}">
                                                                <span class="align-middle">Edit</span></a>
                                                        </li>
                                                        <li>
                                                            <a data-path="{{route('LeadSource.delete', $source->source_id)}}" class="delete-item block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="#!">
