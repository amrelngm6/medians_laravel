                            ...
                            <div class="card-body px-0">
                                ...
                                <div class="border-t border-white/10 pt-6 dark:border-darkmode-400 ">
                                    ...
                                    <div class="w-full my-4  flex gap-2">
                                        <span class="p-2 w-full text-primary"> Folders ( {{count($folders)}} ) </span>
                                        ...
                                        <div class="btn-group mb-1" rel="popover" data-toggle="popover" data-placement="top" data-trigger="hover"
                                            ...
                                            <a class="dropdown-item open-modal fs-2 ps-4 font-semibold textprimary"
                                                href="{{route('EmailAccount.createFolder', $account->id)}}?_token={{csrf_token()}}"><i
                                                    class="bx bx-folder-plus text-danger"></i></a>
                                        </div>
                                    </div>
                                    @foreach ($folders as $folder)
                                    <div class="w-full flex gap-2">
                                        <i class="bx bx-start"></i>
                                        <a class="{{$folder->id == request()->get('folder') ? 'text-danger' : 'text-dark-blue'}} w-full text-hover-info mt-2 flex gap-4 items-center rounded-md py-2 fs-4 "
                                ...
                                <div class="mt-4 border-t border-white/10 pt-4 text-white dark:border-darkmode-400">
                                    ...
                                    <a class="border-t mt-4 pt-4 flex items-center fw-bold rounded-md px-3" href="{{route('EmailAccount')}}">
                                        Show ALL Accounts
                                    </a>
                                </div>
                            </div>
