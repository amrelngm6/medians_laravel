...
<div class="modal fade show active" id="create-email-account-modal" tabindex="-1" >
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header pb-0 border-0 justify-content-end">
                <!--begin::Close-->
                <div class="cursor-pointer text-danger close-modal" data-modal="#create-email-account-modal">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="create_email_account_form" class="ajax-form form" action="{{route('EmailAccount.store')}}" method="POST">
                    @csrf
                    <!--begin::Heading-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="d-flex flex-column  fv-row">
                                    <input placeholder="IMAP host " name="imap_host" value="localhost" required class="form-control form-control-solid" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-15 fv-row">
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="d-flex flex-column  fv-row">
                                    <input placeholder="IMAP port " name="imap_port" value="993" type="number" required class="form-control form-control-solid" />
                                </div>
                            </div>
                        </div>
                    </div>
