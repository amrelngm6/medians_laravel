    ...
    <div class="modal fade  active " id="items-modal" tabindex="-1" >
        <!--begin::Modal dialog-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">
                            Pick from the currently added <a href="{{route('Item')}}"
                                class="fw-bold link-primary">items</a>.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->

                    <form action="{{route('Proposal.item-row')}}" class="w-full ajax-form fs-5 card-body " data-append="true"
                        data-element="variants-container" id="proposal-item-form">
                        @csrf
                        <!--begin::Checkbox-->
