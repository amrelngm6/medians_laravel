    ...
    <div class="card mb-5 mb-xl-10" id="profile_details_view">
        ...
        <div class="card-header cursor-pointer">
            ...
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">Notes list</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div class="card-body p-9">
            ...
            <label
                ...
                <div class="user-img img-fluid"><img src="/{{ $note->user->picture ?? '/data/profile/avatar-2.png'}}" alt="story-img"
                        class="rounded-circle w-50px h-50px"></div>
                <div class="media-support-info px-4 w-full">
                    <h6 class="d-inline-block">{{$note->description}}</h6>
                    <div class="w-full flex mb-0 ">
                        <p class="w-full">by {{ $note->user->name ?? ''}}
                            <span class="badge badge-success badge-sm mx-2">{{date('M d, Y', strtotime($note->created_at))}}</span>
                        </p>
