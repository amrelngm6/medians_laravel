                        ...
                        <div class="card" id="chat_messenger">
                            ...
                            <form class="flex gap-2 pt-4 ajax-form" action="{{route('HuggFace.img2txt')}}" id="wp_chat_messenger_form">
                                @csrf
                                <input name="model"  value="stepfun-ai/GOT-OCR2_0">
                                <textarea class="form-control form-control-solid mb-3" rows="1" name="message" data-kt-element="input"
                                    placeholder="Type a message" id="message-contents"></textarea>
