                        ...
                        <div class="card" id="chat_messenger">
                            ...
                            <form class="flex gap-2 pt-4 ajax-form" action="{{route('HuggFace.img2img')}}" id="wp_chat_messenger_form">
                                @csrf
                                <input name="model"  value="stable-diffusion-v1-5/stable-diffusion-v1-5">
                                <input name="image"  value="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/diffusers/img2img-init.png">
