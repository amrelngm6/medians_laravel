...
<div class="modal fade show active" id="show-timesheet-modal" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                ...
                <table class="w-full bg-white rounded-lg shadow-lg">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-200">
                            <td class="py-4 px-6 text-left">{{date('M d, Y', strtotime($timesheet->date))}} </td>
