                    ...
                    <div class="card-body pb-0">
                        <div class="w-full">
                            <div class="block w-full">
                                ...
                                <p class="block w-full"> Footer & Header background color needs to be changed from dark blue to
                                    light purple...</p>
                            </div>
                        </div>
                        <div class=" mt-10">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 ">
                <div class="card">
                    <div class="card-body pb-0">
                        <div class="w-full">
                            <div class="block w-full">
                                <h4 class="mb-4 block"> <a href="#!" class="open-modal" data-modal="#task-modal">Full Testing at
                                        Dashboard & Other sub-pages </a></h4>
                ...
                <div class="card">
                    <div class="card-body pb-0">
                        <div class="w-full">
                            <div class="block w-full">
                                <h4 class="mb-4 block"> <a href="#!" class="open-modal" data-modal="#task-modal">Change Header,
                                        sidebar and Footer colors </a></h4>
                                <p class="block w-full"> Footer & Header background color needs to be changed from dark blue to
                                    light purple...</p>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 ">
                <div class="card">
                    <div class="card-body pb-0">
                        <div class="w-full">
                            <div class="block w-full">
                                <h4 class="mb-4 block"> <a href="#!" class="open-modal" data-modal="#task-modal">Fix Main Menu
                                        issue</a></h4>
                                <p class="block w-full"> There are many variations of passages of Lorem Ipsum available, but the
                                    majority have ...</p>
                            </div>
                        </div>
                        <div class=" mt-10">
