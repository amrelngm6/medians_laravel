...
<div class="wrapper main-wrapper row" style=''>
    ...
    <div class="col-lg-3 ">
        <div class="card">
            <div class="card-body">
                <a href="{{route('Todo.create')}}" data-modal="#todo-task-modal"
                ...
                <div class="mt-4 border-t border-white/10 pt-4 text-white fs-5 dark:border-darkmode-400">
                    ...
                    <a class="mt-2 flex items-center  rounded-md px-3 py-2 " href="{{route('ToDo')}}?date=today">
                        Show Today only
                    </a>
                    
                    <a class="mt-2 flex items-center  rounded-md px-3 py-2 " href="{{route('ToDo')}}">
                        Show ALL
                    </a>
                    <a class="mt-2 flex items-center text-truncate rounded-md px-3 py-2 open-modal" href="{{route('Priority.create')}}?model=Todo">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
