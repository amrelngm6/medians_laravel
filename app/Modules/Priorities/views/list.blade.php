                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Priorities list </h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <a href="javascript:;">Priorities</a>
                                </li>
                                <li class="active">
                                    <strong>All</strong>
                                </li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center  gap-2 gap-md-5 w-full flex">
                            ...
                            <a class="btn btn-md btn-primary me-2 open-modal " href="{{route('Priority.create')}}">
                                New priority </a>
                        </div>
                                ...
                                <table
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" ">
                                                <h6 class="">{{$Priority->name}} </h6>
                                            </td>
                                            <td class=" ">{{ class_basename($Priority->model) }}  </td>
                                            <td class=" ">
                                                <span class="block fw-semibold bg-{{ $Priority->color }} w-20px h-20px rounded-circle"> </span>
                                            </td>
                                            <td class=" ">
                                                <h6 class="">{{$Priority->sort}} </h6>
                                            </td>
                                            <td class=" action">
                                                    ...
                                                    <ul class="show-on-hover absolute   z-50  py-2 mt-0 text-start list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                        ...
                                                        <li>
                                                            <a class="open-modal block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="{{route('Priority.edit_modal', $Priority->priority_id)}}">
                                                                <span class="align-middle">Edit</span></a>
                                                        </li>
                                                        <li>
                                                            <a data-path="{{route('Priority.delete', $Priority->priority_id)}}" class="delete-item block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="#!">
