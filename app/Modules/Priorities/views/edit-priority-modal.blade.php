    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header pb-0 border-0 justify-content-end">
                <!--begin::Close-->
                <div class="cursor-pointer text-danger close-modal" data-modal="#edit-priority-modal">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form id="modal_edit_target_form" method="POST" class="ajax-form form" action="{{route('Priority.update', $priority->priority_id)}}">
                    @csrf
                    <input name="priority_id" type="hidden" value="{{$priority->priority_id}}" />
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Update Priority</h1>
                        <!--end::Title-->

                        <!--begin::Description-->
                        <div class="text-muted fw-semibold fs-5">
                            Update <span class="text-danger">{{$priority->name}}</span> Models Priority list.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input class="form-control form-control-solid" placeholder="Priority name " value="{{$priority->name}}"
                                name="name" />
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <input class="form-control form-control-solid" type="number" placeholder="Sort" value="{{$priority->sort}}" name="sort" />
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select class="form-control form-control-solid select2" placeholder="Select a Team Member" name="model">
                            ...
                            @if ($Module->path.'\\Models\\'.$Module->name == $priority->model )
                            selected
                            @endif
                            >{{$Module->name}}</option>
                            @endforeach 
                    ...
                    <div class="mb-15 fv-row">
                        ...
                        <div class="flex flex-column">
                            ...
                            <div class="fw-semibold me-5 flex gap-10">
                                ...
                                <div class="pt-1 fs-7 text-muted">Select priority color</div>
                            </div>
                            <!--end::Label-->
                            ...
                            <div class="d-flex align-items-center pt-6">
                                ...
                                <label class="form-check form-check-custom form-check-solid me-10">
                                    <input class="form-check-input h-20px w-20px" type="radio"
                                        name="color" value="{{$color}}" @if ($color == $priority->color ) checked @endif />
