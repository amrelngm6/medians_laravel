...
<div class="modal fade  active " id="edit-invoice" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header pb-0 border-0 justify-content-end">
                <!--begin::Close-->
                <a class="cursor-pointer text-danger close-modal" data-modal="#edit-invoice">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form  id="modal_edit_status_form" method="POST" class="form ajax-form" action="{{route('Invoice.update', $invoice->id)}}">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">
                            Edit status  for invoice <a href="#!"
                                class="fw-bold link-primary">{{$invoice->code ?? ''}}</a>.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select class="form-control form-control-solid " placeholder="Select a Status" name="status_id">
                            ...
                            @if ($statusRow->status_id == $invoice->status_id ) selected @endif
                    ...
                    <div class="form-group w-full"><label for="date" class="control-label" rel="popover"
                        ...
                        <input type="date" class=" form-control form-control-solid  " id="date" name="due_date"
                            class="form-control form-control-solid " value="{{$invoice->due_date}}">
                    </div>
