                            ...
                            <tr>
                                ...
                                <td> <a href="{{route(basename($transaction->model_type).'.show', $transaction->model_id)}}"> {{basename($transaction->model_type) }}</a></td>
                                ...
                                <td>
                                    ...
                                    class=" gap-4 me-2 mt-1.5 inline-flex items-center rounded bg-primary-100  py-0.5 text-xs font-medium text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                                        ...
                                        <a href="javascript:;" data-path="{{route('Transaction.delete', $transaction->id)}}" class="delete-item " ><i class='bx bx-trash fs-4'></i></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
