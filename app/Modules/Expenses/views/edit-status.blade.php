    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header pb-0 border-0 justify-content-end">
                <!--begin::Close-->
                <a class="cursor-pointer text-danger close-modal" data-modal="#edit-expense">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form  id="modal_edit_status_form" method="POST" class="form ajax-form" action="{{route('Expense.update', $expense->id)}}">
                    @csrf
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        ...
                        <div class="text-muted fw-semibold fs-5">
                            Edit status  for expense <a href="#!"
                                class="fw-bold link-primary">{{$expense->code ?? ''}}</a>.
                        </div>
                        <!--end::Description-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <select class="form-control form-control-solid " placeholder="Select a Status" name="status_id">
                            ...
                            @if ($statusRow->status_id == $expense->status_id ) selected @endif
                    ...
                    <div class="form-group w-full"><label for="date" class="control-label" rel="popover"
                            ...
                            data-placement="top" data-content="Set the Issue date of the Expense"
                        ...
                        <input type="date" class=" form-control form-control-solid  " id="date" name="due_date"
                            class="form-control form-control-solid " value="{{$expense->due_date}}">
                    </div>
