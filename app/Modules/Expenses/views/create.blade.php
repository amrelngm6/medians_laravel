                        ...
                        <div class="card-body">
                            <div class="w-full g-3">
                                <div class="col-sm-6 col-xl-3">
                                    <div class="mb-0">
                                        <label class="form-label fs-4">Expense id</label>
                                ...
                                <div class="col-12">
                                    <div class="expense-total py-10 ms-auto d-lg-flex">
                                        <div class="w-full">
                                            <div class="px-10">
                                ...
                                <div class="col-lg-12">
                                    <div class="w-full flex align-items-center justify-content-between g-3">
                                        ...
                                        <div class="flex-none">
                                            <a href="{{route(App::getLocale() . '.apps.expense')}}" class="btn btn-danger">Preview</a>
