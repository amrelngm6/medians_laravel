            ...
            <div class="card mb-5 mb-xl-10" id="profile_details_view">
                ...
                <div class="card-header cursor-pointer w-full">
                    ...
                    <div class="card-title m-0 w-full flex">
                        ...
                        <a href="{{route('Client.edit', $deal->client_id)}}" class="open-modal fw-bold m-0 fs-3"><i class="bx bx-edit"></i></a>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
                ...
                <div class="card-body p-2">
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <a href="javascript:;" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$deal->client->location_info->website ?? ''}}</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <a href="javascript:;" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$deal->client->email}}</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
