                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="javascript:;" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$deal->name}}</a>
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2 fw-bold counted w-full">${{$deal->budget}}</div>
                                            ...
                                            <div
                                                ...
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2 fw-bold counted w-full">{{$deal->tasks_count}}</div>
                                            ...
                                            <div
                                                ...
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2 fw-bold counted w-full">${{$deal->calls_count}}</div>
                                                ...
                                                <div class="mb-0">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <!--begin::Name-->
                                                            <a href="javascript:;"
                                                                class="fs-4 fw-bold text-gray-900 text-hover-primary me-2">{{$deal->company}}</a>
                                                            <!--end::Name-->
