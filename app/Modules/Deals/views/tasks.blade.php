    ...
    <div class="col-lg-12">
        ...
        <div class="card mb-5 mb-xl-10 py-0">
            <div class="card-body p-0 flex w-full">
                ...
                <form action="{{route('Deal.tasks.filter', $deal->id)}}" id="filter-form" class="card-header ajax-form px-0">
                    @csrf
                ...
                <div class="d-flex flex-none align-items-center position-relative my-1 gap-10">
                    <a class="btn btn-md btn-primary me-2 open-modal" href="{{route('Deal.tasks.create', $deal->id)}}" data-modal="#add-task-modal">
                        Add Task </a>
                </div>
