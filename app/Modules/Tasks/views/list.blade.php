                                ...
                                <table
                                    ...
                                    <tbody class="list">
                                        <tr>
                                            ...
                                            <td class=" price">{{$settings['currency_code']}}79.99</td>
                                            <td class=" stock">500</td>
                                            <td class=" revenue">{{$settings['currency_code']}}24,365</td>
                                            <td class=" status">
                                                <span
                                        ...
                                        <tr>
                                            ...
                                            <td class=" price">{{$settings['currency_code']}}214.47</td>
                                            <td class=" stock">400</td>
                                            <td class=" revenue">{{$settings['currency_code']}}1,24,365</td>
                                            <td class=" status"><span
                                        ...
                                        <tr>
                                            ...
                                            <td class=" price">{{$settings['currency_code']}}119.12</td>
                                            <td class=" stock">600</td>
                                            <td class=" revenue">{{$settings['currency_code']}}80,321</td>
                                            <td class=" status"><span
                                        ...
                                        <tr>
                                            ...
                                            <td class=" price">{{$settings['currency_code']}}452.99</td>
                                            <td class=" stock">300</td>
                                            <td class=" revenue">{{$settings['currency_code']}}49,234</td>
                                            <td class=" status"><span
                                                    class="badge round-success px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent">Publish</span>
                                            </td>
                                            <td class=" action">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" category"><span
                                                    ...
                                                    Decor</span></td>
                                            <td class=" price">{{$settings['currency_code']}}119.99</td>
                                            <td class=" stock">240</td>
                                            <td class=" revenue">{{$settings['currency_code']}}20,784</td>
                                            <td class=" status"><span
                                                    class="badge round-success px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent">Publish</span>
                                            </td>
                                            <td class=" action">
                                        ...
                                        <tr>
                                            ...
                                            <td class=" price">{{$settings['currency_code']}}84.99</td>
                                            <td class=" stock">110</td>
                                            <td class=" revenue">{{$settings['currency_code']}}15,493</td>
                                            <td class=" status"><span
                                                    class="badge round-danger px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-orange-100 border-transparent text-orange-500 dark:bg-orange-500/20 dark:border-transparent">Unpublish</span>
                                            </td>
                                            <td class=" action">
