...
@section('title', 'Create credit_note')
@section('css')
                ...
                <div class='col-xs-12'>
                    <div class="page-title">
                        ...
                        <div class="pull-left">
                            ...
                            <h1 class="title">Create CreditNote</h1>
                        ...
                        <div class="pull-right hidden-xs">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <strong>Create CreditNote</strong>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="w-full g-3">
                                <div class="col-sm-6 col-xl-3">
                                    <div class="mb-0">
                                        <label class="form-label fs-4">CreditNote id</label>
                                ...
                                <div class="col-12">
                                    <div class="credit_note-total py-10 ms-auto d-lg-flex">
                                        <div class="w-full">
                                            <div class="px-10">
                                        ...
                                        <div class="w-50 flex flex-column fs-5">
                                            ...
                                            <div class="flex gap-10 py-2">
                                                ...
                                                <div class="">
                                                    <p class="f-w-600 mb-1 text-end">{{$settings['currency_code']}}20.00</p>
                                                </div>
                                            </div>
                                            <div class="flex gap-10 py-2">
                                                <div class="w-full">
                                                ...
                                                <div class="">
                                                    <p class="f-w-600 mb-1 text-end text-success">{{$settings['currency_code']}}10.00</p>
                                                </div>
                                            </div>
                                            <div class="flex gap-10 py-2">
                                                <div class="w-full">
                                                ...
                                                <div class="">
                                                    <p class="f-w-600 mb-1 text-end text-success">{{$settings['currency_code']}}5.000</p>
                                                </div>
                                            </div>
                                            <div class="flex gap-10 py-2">
                                                <div class="w-full">
                                                ...
                                                <div class="">
                                                    <p class="f-w-600 mb-1 text-end text-success">{{$settings['currency_code']}}25.00</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="w-full flex align-items-center justify-content-between g-3">
                                        ...
                                        <div class="flex-none">
                                            <a href="{{route(App::getLocale() . '.apps.credit_note')}}" class="btn btn-danger">Preview</a>
