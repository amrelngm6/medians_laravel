    ...
    <div class="card w-full">
        ...
        <div class="card-header cursor-pointer">
            ...
            <div class="card-title m-0 flex w-full">
                <h3 class="fw-bold m-0 w-full">Estimates list</h3>
                <span onClick="(function(){jQuery('#estimate-form').toggle()})()" class="fw-bold m-0 btn btn-md btn-primary ">Add Estimate
                        </span>
            </div>
            <!--end::Card title-->
        </div>
            ...
            <div class="w-full flex gap-10">
                ...
                <div class="form-group w-full"><label for="expiry_date" class="control-label" rel="popover"
                    ...
                    <input type="date" class=" form-control form-control-solid  " min="{{date('Y-m-d')}}"
                        id="expiry_date" name="expiry_date" class="form-control form-control-solid " value="{{date('Y-m-d')}}">
                </div>
            </div>
            <div class="w-full flex gap-10">
            ...
            <div class="divide-y divide-gray-200 dark:divide-gray-700 w-full card card-flush mb-0 py-0">
                <div class="flex  items-center gap-y-4 pt-4  w-full gap-2">
                    ...
                    <dl class="min-w-150px">
                        ...
                        <dd
                            class="me-2 mt-1.5 inline-flex items-center rounded bg-primary-100 px-2.5 py-0.5 text-sm font-medium text-white bg-{{$estimate->status->color ?? ''}} dark:bg-primary-900 dark:text-primary-300">
