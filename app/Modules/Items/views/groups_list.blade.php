                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center  gap-2 gap-md-5 w-full flex">
                            ...
                            <a class="btn btn-md btn-primary  open-modal" href="{{route('ItemGroup.create')}}">
                                New Group </a>
                        </div>
                                ...
                                <table
                                    ...
                                    <thead class="text-start bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            ...
                                            <th class="text-start task_name" data-sort="task_name">Name</th>
                                    ...
                                    <tbody class="list">
                                        ...
                                        <tr>
                                            <td class="">
                                                <a href="#!"
                                                    class="transition-all duration-150 ease-linear task_code text-custom-500 hover:text-custom-600">#{{$group->id}}</a>
                                            </td>
                                                    ...
                                                    <ul class="show-on-hover absolute   z-50  py-2 mt-0 text-start list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                        ...
                                                        <li>
                                                            <a class="open-modal block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="{{route('ItemGroup.edit', $group->id)}}?_token={{csrf_token()}}">
                                                                <span class="align-middle">Edit</span></a>
                                                        </li>
                                                        <li>
                                                            <a data-path="{{route('ItemGroup.delete', $group->id)}}" class="delete-item block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 "
                                                                href="#!">
