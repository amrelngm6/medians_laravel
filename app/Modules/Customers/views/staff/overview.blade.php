                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 fv-row">
                                <span class="fw-semibold text-gray-800 fs-6">{{$staff->position}}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                ...
                                <a href="tel:{{$staff->phone}}" class="badge bg-success"><i class="bx bx-phone"></i> Call</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <a href="javascript:;" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$staff->location_info->website ?? ''}}</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <a href="javascript:;" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$staff->email}}</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800">{{$staff->location_info->country ?? ''}}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
