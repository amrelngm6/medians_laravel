            ...
            <div class='col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        ...
                        <h1 class="title">@yield('nav-title', 'Staff')</h1>
                ...
                <div class="card mb-5 mb-xl-10 py-0">
                    <div class="card-body pt-9 pb-0">
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex align-items-center mb-2">
                                            <a href="javascript:;" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$staff->name ?? ''}}</a>
                                        ...
                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 ">
                                            ...
                                            <a href="#!"
                                                class="d-flex align-items-center text-muted text-hover-primary me-5 mb-2">
                                                 {{$staff->location_info->city ?? ''}}, {{$staff->location_info->country ?? ''}}
                                            </a>
                                        ...
                                        <div class="d-flex flex-wrap">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2 fw-bold counted w-full">${{$staff->budget}}</div>
                                            ...
                                            <div
                                                ...
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2 fw-bold counted w-full">{{$staff->tasks_count}}</div>
                                            ...
                                            <div
                                                ...
                                                <!--begin::Number-->
                                                <div class="d-flex align-items-center">
                                                    <div class="fs-2 fw-bold counted w-full">${{$staff->calls_count}}</div>
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            @foreach ($staffTabs as $tabItem)
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5 "
                                    href="{{route($tabItem['route'], $staff->staff_id)}}">
                                    {{$tabItem['name']}} </a>
                            </li>
                            <!--end::Nav item-->
                            @endforeach
