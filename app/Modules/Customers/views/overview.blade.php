            ...
            <div class="col-lg-12">
                <div class="card mb-5 mb-xl-10" id="profile_details_view">
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            <!--begin::Label-->
                            <label class="col-lg-4 fw-semibold text-muted">Position <i class='bx bx-buildings'></i></label>
                            <!--end::Label-->

                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row">
                                <span class="fw-semibold text-gray-800 fs-6">{{$client->position}}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                ...
                                <a href="tel:{{$client->phone}}" class="badge bg-success"><i class="bx bx-phone"></i> Call</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <a href="javascript:;" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$client->location_info->website ?? ''}}</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <a href="javascript:;" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{$client->email}}</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800">{{$client->location_info->country ?? ''}}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
