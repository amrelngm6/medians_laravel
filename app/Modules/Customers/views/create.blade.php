...
@section('nav-title', 'Create Client Member')

@section('client-page')
<div class="col-md-12">
    <form action="{{route('Client.store')}}" id="form" class="ajax-form" method="POST">
        @csrf
        ...
        <div class="card w-full">
            <div class="card-body">
                ...
                <div class="mb-2 text-start">
                    ...
                    <div class="text-muted fw-semibold fs-5">
                        <p class="fw-semibold">Information about the Client & his rules</p>.
                    </div>
                </div>
