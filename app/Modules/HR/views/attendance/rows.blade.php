                                ...
                                <table class="w-full datatable-default whitespace-nowrap table table-striped">
                                    <thead
                                        ...
                                        <tr class="*:px-3.5 *:py-2.5 *:border-y *:border-slate-200 *:dark:border-zink-500">
                                            ...
                                            <td class="fs-1">
                                                ...
                                                @elseif (in_array($dayDate, $dates)) <span rel="popover" data-toggle="popover" data-trigger="hover" data-html="1"
                                                    ...
                                                    data-content="Check-in: <b>{{isset($monthAttendance[$dayDate][0]['check_in']) ? date('H:i a', strtotime($monthAttendance[$dayDate][0]['check_in'])) : ''}}</b> <br /> Check-out: <b>{{isset($monthAttendance[$dayDate][0]['check_out']) ? date('H:i a', strtotime($monthAttendance[$dayDate][0]['check_out'])) : 'Still working'}}</b>"> <i class="bx bx-check text-danger "></i></span>
