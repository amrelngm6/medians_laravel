...
<div class="col-sm-12">
    <div class="card">
        <form id="change-date" action="{{route('Templates.ajax')}}"
            ...
            <a class="btn btn-md btn-primary me-2" href="{{route('Templates.create')}}">
                                New Template </a>
        </form>
    </div>
</div>
