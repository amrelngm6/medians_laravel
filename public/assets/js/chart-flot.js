...
jQuery(function($) {
    ...
    /*--------------------------------
        Flot Chart
     --------------------------------*/
    MediansSettings.chartFlot = function() {
            ...
            function plotAccordingToChoices() {
                ...
                if (data.length > 0) {
                    $.plot("#flot-toggle", data, {
                        ...
                        colors: ["#F8285A", "#F8285A", "#071437", "#FFC107", "#797979"],
                        grid: {
                            tickColor: "#f5f5f5",
                            borderWidth: 1,
                            borderColor: "#eaeaea"
        ...
        if ($("#flot-track").length) {
            ...
            var trackplot = $.plot("#flot-track", [{
                ...
                colors: ["rgb(0,42,82)", "#F8285A", "#E91E63", "#FFC107", "#797979"],
            });
        ...
        if ($("#flot-visitors").length) {
            ...
            var options = {
                ...
                colors: ["#F8285A", "#e8962e", "#E91E63", "#FFC107", "#797979"],
                grid: {
        ...
        if ($("#demoarea-chart #demoarea-container").length) {
            ...
            $("#demoarea-container").bind("plothover", function (event, pos, item) {
            ...
            $("#demoarea-container").bind("plothovercleanup", function (event, pos, item) {
                    $("#tooltip").hide();
            });

            $("#demoarea-container").bind("plotclick", function (event, pos, item) {
                if (item) {
