...
jQuery(function($) {
    ...
    /*--------------------------------
        Morris Chart
     --------------------------------*/
    MediansSettings.chartMorris=function() {
        if($("#morris_area_graph").length) {
            ...
            Morris.Area( {
                ...
                ], resize: true, redraw: true, xkey: 'x', ykeys: ['y', 'z'], labels: ['Y', 'Z'], lineColors: ['#F8285A', 'rgb(0,42,82)'], pointFillColors: ['rgb(0,42,82)']
            }
        ...
        if($("#morris_bar_graph").length) {
            ...
            Morris.Bar( {
                ...
                ], resize: true, redraw: true, xkey: 'x', ykeys: ['y', 'z', 'a'], labels: ['Y', 'Z', 'A'], barColors: ['#F8285A', '#4CAF50', 'rgb(0,42,82)']
            }
            ).on('click', function(i, row) {
                console.log(i, row);
            }
        ...
        if($("#morris_line_graph").length) {
            ...
            Morris.Line( {
                element: 'morris_line_graph', data: day_data, resize: true, xkey: 'period', ykeys: ['licensed', 'sorned'], labels: ['Registered', 'Purchase'], lineColors: ['#F8285A', 'rgb(0,42,82)'], pointFillColors: ['rgb(0,42,82)']
            }
            );
        }
        if($("#morris_donut_graph").length) {
            ...
            Morris.Donut( {
                ...
                ], resize: true, redraw: true, backgroundColor: '#ffffff', labelColor: '#999999', colors: [ "40-#F8285A-#e45131:70-#e45131-#e45131:90-#e45131", '#f7f7f7']
            }
            );
        }
        if($("#morris_negative_graph").length) {
            ...
            Morris.Line( {
                element: 'morris_negative_graph', data: neg_data, resize: true, redraw: true, xkey: 'period', ykeys: ['a'], labels: ['Series A'], lineColors: ['#F8285A', 'rgb(0,42,82)'], units: '%'
            }
            );
        }
        if($("#morris_nogrid_graph").length) {
            ...
            Morris.Line( {
                element: 'morris_nogrid_graph', grid: false, resize: true, redraw: true, data: day_data, xkey: 'period', ykeys: ['licensed', 'sorned'], labels: ['Licensed', 'SORN'], lineColors: ['#F8285A', 'rgb(0,42,82)']
            }
            );
        }
        if($("#morris_noncontinuous_graph").length) {
            ...
            Morris.Line( {
                element: 'morris_noncontinuous_graph', data: day_data, resize: true, redraw: true, xkey: 'period', ykeys: ['licensed', 'sorned', 'other'], labels: ['Licensed', 'SORN', 'Other'], lineColors: ['#F8285A', 'rgb(0,42,82)'], /* custom label formatting with `xLabelFormat` */
        ...
        if($("#morris_stackedbar_graph").length) {
            ...
            Morris.Bar( {
                ...
                ], resize: true, redraw: true, xkey: 'x', ykeys: ['y', 'z', 'a'], labels: ['Y', 'Z', 'A'], barColors: ['#F8285A', '#4CAF50', 'rgb(0,42,82)'], stacked: true
            }
            );
        }
    };
